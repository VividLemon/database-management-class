...
namespace Final {
    ...
    public partial class FinalDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string Name, string Description, double Price) {
...
namespace Final.FinalDataSet2TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Name], [Description], [Price]) VALUES (@Name, @Des" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [Name] = @Name, [Description] = @Description, [Price]" +
                " = @Price WHERE (([Id] = @Original_Id) AND ([Price] = @Original_Price));\r\nSELECT" +
                " Id, Name, Description, Price FROM Products WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Description, Price FROM dbo.Products";
        ...
        public virtual int Fill(FinalDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual FinalDataSet2.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FinalDataSet2.ProductsDataTable dataTable = new FinalDataSet2.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FinalDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual int Update(string Name, string Description, double Price, int Original_Id, double Original_Price, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, double Price, int Original_Id, double Original_Price) {
            return this.Update(Name, Description, Price, Original_Id, Original_Price, Original_Id);
        }
    }
