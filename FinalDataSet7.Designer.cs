...
namespace Final.FinalDataSet7TableAdapters {
...
SELECT Id, CreatedAt, Name, DateOfBirth, PhoneNumber, Address, State, Zip, Salary FROM Employees WHERE (Id = @Id)";
        ...
        public virtual int Fill(FinalDataSet7.EmployeesDataTable dataTable) {
        ...
        public virtual FinalDataSet7.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FinalDataSet7.EmployeesDataTable dataTable = new FinalDataSet7.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FinalDataSet7.EmployeesDataTable dataTable) {
